...
nombres_vendedores = ['AURA DUEZ','HENRY MENDOZA','ANDERSON MEJIAS','LENNYS OJEDA','LUIS DIAZ','FELIX AVILAN',
                     'JORGE KEWAYFATI','NEEDMI CASANOVA','EDGAR RAZZAK','MAITE DE SANTIAGO','SALVADOR RIVAS',
                     'ARNALDO CAMEJO','OLGA LINARES','JUAN MORA','SANDRA SEGNINI','ANTONIO ANDRES TERAN','ROBERTO SEPULVEDA','PEDRO SOTO','JOSE LEONET','KEYLA CARDENAS']
