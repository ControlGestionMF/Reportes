...
nombres_vendedores = ['DANIEL CHACON','HENRY MENDOZA','JESUS PEÑARANDA','LENNYS OJEDA','LUIS DIAZ','FELIX AVILAN',
                     'ANDERSON MEJIAS','ELVER ROMERO','NEEDMI CASANOVA','MAITE DE SANTIAGO','ORLANDO LUGO',
                     'AURA DUEZ','OLGA LINARES','JOEL MARIN','SANDRA SEGNINI','ANTONIO ANDRES TERAN','ROBERTO SEPULVEDA','LUIS BELLO','PEDRO SOTO','CAMILA FARFAN','MARIA EUGENIA LANDAETA']
